...
namespace EmployeeDatabaseForDataWarehousing.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(EmployeeDatabaseForDataWarehousingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Address != null ? 
                          ...
                          Problem("Entity set 'EmployeeDatabaseForDataWarehousingContext.Address'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Address_id,City,Country")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Address_id,City,Country")] Address address)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EmployeeDatabaseForDataWarehousingContext.Address'  is null.");
            }
            var address = await _context.Address.FindAsync(id);
            if (address != null)
            {
